...
directory = '/scratch/premacht/python_projects_2023/pop_comparisons'
os. chdir(directory)
...
python3 compare_populations.py combined_Chr${SLURM_ARRAY_TASK_ID}.g.vcf.gz_Chr${SLURM_ARRAY_TASK_ID}_GenotypedSNPs.vcf.gz_filtered.vcf.gz_selected.vcf.gz.tab my_sample_list_with_sex_and_pop.txt Tropicalis Liberia Calcaratus
```

Or run it on local machine
